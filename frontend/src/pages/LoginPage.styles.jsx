...
export const GLASS_WHITE = 'rgba(255, 255, 255, 0.1)';
...
export const loginStyles = {
  ...
  // Partie formulaire avec dégradé subtil
  formContainer: {
    flex: 1,
  ...
  mainTitle: {
    ...
    background: `linear-gradient(135deg, ${PRIMARY_GREEN} 0%, ${LIGHT_GREEN} 50%, ${ACCENT_ORANGE} 100%)`,
  ...
  avatar: (isSmallScreen, isHovered) => ({
    ...
    '&::before': {
      ...
      inset: -2,
      borderRadius: '50%',
      background: `linear-gradient(135deg, ${ACCENT_ORANGE}, ${PRIMARY_GREEN})`,
  ...
  // Champs de formulaire avec effets
  textField: {
    mb: 2,
  ...
  // Bouton de connexion avec dégradé et animations
  loginButton: (isSmallScreen) => ({
  ...
  // Partie visuelle droite - Design immersif
  visualSection: {
    flex: 1,
    minWidth: 420,
    display: 'flex',
    ...
    justifyContent: 'center',
    alignItems: 'center',
    background: `linear-gradient(135deg, ${PRIMARY_GREEN} 0%, ${DARK_GREEN} 50%, #1a472a 100%)`,
    backgroundImage: `
    ...
    '&::before': {
      ...
      right: 0,
      bottom: 0,
      background: 'radial-gradient(circle at 20% 50%, rgba(255, 152, 0, 0.15) 0%, transparent 50%)',
  ...
  // Carte glassmorphism dans la section visuelle
  visualCard: {
    p: 3,
    ...
    boxShadow: '0 12px 32px rgba(0, 0, 0, 0.25), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
  ...
  // Snackbar personnalisé avec glassmorphism
  snackbarAlert: {
    borderRadius: 2.5,
    fontWeight: 600,
    fontSize: '0.95rem',
